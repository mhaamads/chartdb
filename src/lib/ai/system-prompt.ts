...
export function buildSystemPrompt(opts: SystemPromptOptions): string {
    ...
    return [
        ...
        `13. For module or table documentation, inspect the target metadata and user-provided context, write complete concise Markdown content, then call add_context_notes once for the batch. Target exactly one existing area or table per note and choose inside/next_to placement deliberately.`,
        snapshot,
    ].join('\n');
}
